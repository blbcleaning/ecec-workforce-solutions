...
export async function POST(request: Request) {
  try {
      ...
      html: `
        ...
        <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="margin: 30px 0; text-align: center;">
            <a href="https://ececworkforcesolutions.au/book" style="display: inline-block; background-color: #c6a052; color: #1a365d; padding: 14px 28px; text-decoration: none; border-radius: 8px; font-weight: 600;">Book a Call to Get Started</a>
          </div>
          ...
          <p style="font-size: 12px; color: #666; text-align: center;">
            ...
            <a href="https://ececworkforcesolutions.au" style="color: #1a365d;">ececworkforcesolutons.au</a>
          </p>
        </body>
        </html>
      `,
    ...
    await resend.emails.send({
      from: "ECEC Workforce Solutions <noreply@ececworkforcesolutions.au>",
      to: "lindsay@ececworkforcesolutions.au",
